...
*A collection of custom poker bots and simulation sandbox*

## Overview
This repository originally started as a project for the AI Poker @ Apogee 2026 competition, but has since expanded into a sandbox environment for testing and developing various custom poker bots and strategies. It provides a simulation framework alongside different custom players to test, compare, and implement custom poker logic.
...
## BasicRuleBasedPlayer
The [BasicRuleBasedPlayer](file:///Users/paarth/Desktop/aipoker/AI-Poker-2025/BRBP.py) class implements a rule-based poker bot.

**Key Features:**
- **Chen Formula Starting Hand Strength**: Calculates pre-flop card values using the Chen starting hand rating.
- **Positional Awareness**: Plays wider/looser from late position and tighter from early position.
- **Dynamic Aggression States**: Switches to an aggressive betting state when holding Three of a Kind or better.
- **Draw Detection & Evaluation**: Evaluates flush and straight draws combined with community cards, and calls based on pot-odds thresholds.
